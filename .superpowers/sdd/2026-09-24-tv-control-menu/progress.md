# SDD ledger - plan: docs/superpowers/plans/2026-09-24-tv-control-menu.md

Pre-flight: 6 cohesive tasks planned.
Mode: Native execution with TDD verification.
Antislop: DURING (no em dashes, no dead buttons, ENERGY 1 / RHYTHM 1 / MOTION 1, WCAG AA contrast).

Task 1: complete (commits f4776cc..ba72f79, tests: node tests/tv-devices-schema-migration.test.js -> PASS)
